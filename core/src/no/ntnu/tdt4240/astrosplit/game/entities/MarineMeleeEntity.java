...
public class MarineMeleeEntity extends UnitEntity {


	public MarineMeleeEntity(){
	...
	public Entity create(
		...
		tc.region = new TextureRegion(assetManager.get(Assets.unit_marine_melee, Texture.class));
		tm.scale.set(0.1f, 0.1f);
		tp.unitClassType = unitClassType;
		tp.teamType = TeamType.TEAM_MARINES;
